...
class ViewController: UIViewController , UITableViewDelegate,UITableViewDataSource {
 ...
 var jeepCar = [Jeep]()
    ...
    let cell = tableView.dequeueReusableCell(withIdentifier: "dataCell") as! ClassTabelViewTableViewCell
       //var content = cell.defaultContentConfiguration()
       let content = jeepCar[indexPath.row]
        cell.printElement(name: content.title, viewElement: content.photo, describe: content.description)
       cell.accessoryType = .disclosureIndicator
          return cell
    }
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
       // name = title?.debugDescription
