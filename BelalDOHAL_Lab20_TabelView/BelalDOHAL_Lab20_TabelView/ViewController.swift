...
extension ViewController: UITableViewDelegate, UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return arrayOfTypes[section].count
    }
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        contain.image = UIImage(named: arrayOfTypes[indexPath.section][indexPath.row].name)
        contain.text = arrayOfTypes[indexPath.section][indexPath.row].name
        contain.secondaryText = arrayOfTypes[indexPath.section][indexPath.row].special
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        jobsNamesSender = arrayOfTypes[indexPath.section][indexPath.row].name
        jobDescreptionsSender = arrayOfTypes[indexPath.section][indexPath.row].descreption
        performSegue(withIdentifier: "toJobIntroduction", sender: self)
    }
    func tableView(_ tableView: UITableView, titleForFooterInSection section: Int) -> String? {
        return "End of \(nameOfTypes[section]) Jobs"
    }
    func tableView(_ tableView: UITableView, titleForHeaderInSection section: Int) -> String? {
        return "\(nameOfTypes[section]) Jobs"
    }
